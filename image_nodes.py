...
class ImageBatchTestPattern:
    ...
    def INPUT_TYPES(s):
        return {"required": {
            ...
            "font": (folder_paths.get_filename_list("swwan_fonts"), ),
    ...
    def generatetestpattern(self, batch_size, font, font_size, start_from, width, height, text_x, text_y):
        ...
        font_path = folder_paths.get_full_path("swwan_fonts", font)
...
"""
    ...
    def addlabel(self, image, text_x, text_y, text, height, font_size, font_color, label_color, font, direction, caption=""):
        ...
        font_path = os.path.join(script_directory, "fonts", "TTNorms-Black.otf") if font == "TTNorms-Black.otf" else folder_paths.get_full_path("swwan_fonts", font)
...
NODE_CLASS_MAPPINGS = {
    ...
    "ImagePrepForICLora": ImagePrepForICLora,
    "ImageAndMaskPreview": ImageAndMaskPreview,
    "CrossFadeImages": CrossFadeImages,
    "CrossFadeImagesMulti": CrossFadeImagesMulti,
    "TransitionImagesMulti": TransitionImagesMulti,
    "TransitionImagesInBatch": TransitionImagesInBatch,
    "ImageBatchJoinWithTransition": ImageBatchJoinWithTransition,
    "ShuffleImageBatch": ShuffleImageBatch,
    ...
    "SaveImageKJ": SaveImageKJ,
    "SaveStringKJ": SaveStringKJ,
    "FastPreview": FastPreview,
    "ImageCropByMaskAndResize": ImageCropByMaskAndResize,
    "ImageCropByMask": ImageCropByMask,
    "ImageUncropByMask": ImageUncropByMask,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "ImageGridComposite2x2": "Image Grid Composite 2x2 (Swwan)",
    "ImageGridComposite3x3": "Image Grid Composite 3x3 (Swwan)",
    "ImageBatchTestPattern": "Image Batch Test Pattern (Swwan)",
    "ImageGrabPIL": "Image Grab PIL (Swwan)",

    "WebcamCaptureCV2": "Webcam Capture CV2 (Swwan)",
    "AddLabel": "Add Label (Swwan)",
    "GetImageSizeAndCount": "Get Image Size & Count (Swwan)",
    "GetLatentSizeAndCount": "Get Latent Size & Count (Swwan)",
    "ImageBatchRepeatInterleaving": "Image Batch Repeat Interleaving (Swwan)",
    "ImageUpscaleWithModelBatched": "Image Upscale With Model Batched (Swwan)",
    "ImageNormalize_Neg1_To_1": "Image Normalize -1 to 1 (Swwan)",
    "RemapImageRange": "Remap Image Range (Swwan)",
    "SplitImageChannels": "Split Image Channels (Swwan)",
    "MergeImageChannels": "Merge Image Channels (Swwan)",
    "ImagePadForOutpaintMasked": "Image Pad For Outpaint Masked (Swwan)",
    "ImagePadForOutpaintTargetSize": "Image Pad For Outpaint Target Size (Swwan)",
    "ImagePrepForICLora": "Image Prep For IC Lora (Swwan)",
    "ImageAndMaskPreview": "Image And Mask Preview (Swwan)",
    "CrossFadeImages": "Cross Fade Images (Swwan)",
    "CrossFadeImagesMulti": "Cross Fade Images Multi (Swwan)",
    "TransitionImagesMulti": "Transition Images Multi (Swwan)",
    "TransitionImagesInBatch": "Transition Images In Batch (Swwan)",
    "ImageBatchJoinWithTransition": "Image Batch Join With Transition (Swwan)",
    "ShuffleImageBatch": "Shuffle Image Batch (Swwan)",
    "GetImageRangeFromBatch": "Get Image Range From Batch (Swwan)",
    "ImageBatchExtendWithOverlap": "Image Batch Extend With Overlap (Swwan)",
    "GetLatentRangeFromBatch": "Get Latent Range From Batch (Swwan)",
    "InsertLatentToIndex": "Insert Latent To Index (Swwan)",
    "ImageBatchFilter": "Image Batch Filter (Swwan)",
    "GetImagesFromBatchIndexed": "Get Images From Batch Indexed (Swwan)",
    "InsertImagesToBatchIndexed": "Insert Images To Batch Indexed (Swwan)",
    "PadImageBatchInterleaved": "Pad Image Batch Interleaved (Swwan)",
    "ReplaceImagesInBatch": "Replace Images In Batch (Swwan)",
    "ReverseImageBatch": "Reverse Image Batch (Swwan)",
    "ImageBatchMulti": "Image Batch Multi (Swwan)",
    "ImageTensorList": "Image Tensor List (Swwan)",
    "ImageAddMulti": "Image Add Multi (Swwan)",
    ...
    "SaveImageKJ": "Save Image KJ (Swwan)",
    "SaveStringKJ": "Save String KJ (Swwan)",
    "FastPreview": "Fast Preview (Swwan)",
    "ImageCropByMaskAndResize": "Image Crop By Mask And Resize (Swwan)",
    "ImageCropByMask": "Image Crop By Mask (Swwan)",
    "ImageUncropByMask": "Image Uncrop By Mask (Swwan)",
